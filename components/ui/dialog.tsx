...
const DialogVariants = cva(
  cn(
    ...
    "lg:left-[50%] lg:top-[50%] lg:grid lg:w-full lg:max-w-lg 2xl:max-w-2xl lg:translate-x-[-50%] lg:translate-y-[-50%] lg:border border-neutral-200 dark:border-neutral-800 lg:duration-200 lg:data-[state=open]:animate-in lg:data-[state=closed]:animate-out lg:data-[state=closed]:fade-out-0 lg:data-[state=open]:fade-in-0 lg:data-[state=closed]:zoom-out-95 lg:data-[state=open]:zoom-in-95 lg:data-[state=closed]:slide-out-to-left-1/2 lg:data-[state=closed]:slide-out-to-top-[48%] lg:data-[state=open]:slide-in-from-left-1/2 lg:data-[state=open]:slide-in-from-top-[48%] lg:rounded-xl"
  ),
  {
    variants: {
      side: {
